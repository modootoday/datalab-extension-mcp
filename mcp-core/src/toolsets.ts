...
/**
 * The one group exported as real tool definitions, so the most common question
 * needs no round trip. Discovery costs three exchanges — list, schema, call —
 * and every one of them is a place a model can lose the thread.
 */
export const NATIVE_TOOLSET = "blog-brief";
