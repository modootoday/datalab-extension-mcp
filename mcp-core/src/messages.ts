...
export const BRIDGE_AGENT_HINT = Object.freeze({
  ...
  connectorStuck:
    "The local connector stopped responding, so this tool cannot run right now. Do not retry immediately; ask the user to turn the MCP connection off and on again in the Chrome side panel.",
});
