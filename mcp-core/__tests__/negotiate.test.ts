...
describe("negotiateProtocol", () => {
  ...
  // 🔴 Highest-common, not newest-offered: an extension that learns a new
  // version must still work against a server that has not been updated.
  ...
  // The message must name which side to update, or the user is left diffing
  // two arrays.
