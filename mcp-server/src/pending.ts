...
export class PendingRegistry<T = unknown> {
  ...
  /**
   * Is this id one of ours, without settling it?
   *
   * What separates "not this session's reply" from "this session's reply,
   * from a caller not allowed to send it". Settling first and asking after
   * cannot express the second — the answer has already landed.
   */
